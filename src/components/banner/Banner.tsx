    ...
    <section className="relative w-full overflow-hidden bg-white min-h-[500px] md:min-h-[650px] flex items-center justify-center pt-24 md:pt-32 pb-16">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none max-w-7xl mx-auto w-full h-full">
        ...
        <motion.div 
          ...
          className="absolute top-[65%] left-[8%] md:left-[22%] w-14 md:w-20 lg:w-24 opacity-80 md:opacity-100 drop-shadow-xl"
        >
          <Image src={image2} alt="Vrbo" className="w-full h-auto" />
        </motion.div>
        ...
        <motion.div 
          ...
          className="absolute top-[20%] right-[5%] md:right-[18%] w-16 md:w-24 lg:w-28 opacity-80 md:opacity-100 drop-shadow-xl"
        >
          <Image src={image3} alt="Booking" className="w-full h-auto" />
        </motion.div>
        ...
        <motion.div 
          ...
          className="absolute top-[70%] right-[8%] md:right-[20%] w-14 md:w-20 lg:w-24 opacity-80 md:opacity-100 drop-shadow-xl"
        >
